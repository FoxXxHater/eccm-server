...
<!-- Edit Device Modal -->
<div class="modal-backdrop" id="editDeviceModal"><div class="modal"><h4><?=$t('edit')?> <?=$t('layout_device')?></h4><div class="row"><label for="editDevName" style="min-width:100px"><?=$t('device_name')?></label><input id="editDevName" type="text" /></div><div class="row"><label for="editDevPorts" style="min-width:100px"><?=$t('device_ports')?></label><input id="editDevPorts" type="number" min="1" max="9999" /></div><div class="row"><label for="editDevType" style="min-width:100px"><?=$t('device_type')?></label><select id="editDevType"><option value="">—</option><option value="router">Router</option><option value="switch">Switch</option><option value="firewall">Firewall</option><option value="server">Server</option><option value="access_point">Access Point</option><option value="modem">Modem</option><option value="patch_panel">Patch Panel</option><option value="pc">PC / Workstation</option><option value="printer">Printer</option><option value="cloud">Cloud / Internet</option><option value="nas">NAS / Storage</option><option value="phone">IP Phone</option></select></div><div class="row"><label style="min-width:100px"><?=$t('device_colour')?></label><div class="color-picker-row"><button type="button" class="color-btn" id="editOpenPalette"><?=$t('select_colour')?></button><span id="editDevColorPreview" class="swatch swatch-lg"></span></div></div><div class="actions"><button id="editDevCancel"><?=$t('cancel')?></button><button id="editDevSave" class="btn"><?=$t('save')?></button></div></div></div>
