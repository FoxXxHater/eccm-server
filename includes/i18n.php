...
'port_help'           => ['de'=>'Zwei freie Ports klicken um sie zu verbinden', 'en'=>'Click two free ports to connect'],
'unlink_help'         => ['de'=>'Trennen in "Verbindungen"', 'en'=>'Unlink in Connections'],
'alias_help'          => ['de'=>'Alt-Klick um eien Alias festzulegen', 'en'=>'Alt-click to set an alias'],
'reserve_help'        => ['de'=>'CTRL-Klick um einen Port zu Reservieren', 'en'=>'CTRL-click to Reserve a port'],

'backup_restore'      => ['de'=>'Sichern / Wiederherstellen (aller Profile)', 'en'=>'Backup / Restore (all profiles)'],
'backup_all'          => ['de'=>'Sicherung erstellen', 'en'=>'Backup all'],
...
'perm_patch'          => ['de'=>'Patch edit.',       'en'=>'edit Patch'],
'perm_add_patch'      => ['de'=>'Patch hinzufügen',        'en'=>'add Patch'],
'perm_edit_device'    => ['de'=>'Gerät edit.',   'en'=>'Edit dev.'],
'perm_add_device'     => ['de'=>'Geräte hinz.',        'en'=>'add Devices'],
'perm_delete'         => ['de'=>'Löschen',       'en'=>'Delete'],
'perm_manage'         => ['de'=>'Verwalten',     'en'=>'Manage'],
'perm_export'         => ['de'=>'Export',        'en'=>'Export'],
'perm_backup'         => ['de'=>'Backup',        'en'=>'Backup'],
...
// ── Connection table ──
'conn_device_a'       => ['de'=>'A Seite',      'en'=>'A Site'],
'conn_port'           => ['de'=>'Port',          'en'=>'Port'],
'conn_alias'          => ['de'=>'Alias',         'en'=>'Alias'],
'conn_device_b'       => ['de'=>'B Seite',      'en'=>'B Site'],
...
// ── Port context menu (used by eccm-core.js via T object) ──
'port_settings'       => ['de'=>'Port-Einstellungen','en'=>'Port settings'],
'port_name'           => ['de'=>'Port-Name',     'en'=>'Port name'],
'port_alias'          => ['de'=>'Alias',          'en'=>'Alias'],
'link_speed'          => ['de'=>'Linkgeschwindigkeit','en'=>'Link speed'],
'port_color'          => ['de'=>'Portfarbe',      'en'=>'Port color'],
'port_note'           => ['de'=>'Notiz',          'en'=>'Note'],
'port_note_ph'        => ['de'=>'Notizen...',     'en'=>'Notes...'],
'linked_to'           => ['de'=>'Verbunden mit',  'en'=>'Linked to'],
'reset_default'       => ['de'=>'Standard wiederherstellen','en'=>'Reset to default'],
'reset_color'         => ['de'=>'Farbe zurücksetzen','en'=>'Reset color'],
'revert_auto'         => ['de'=>'Automatischen Wert wiederherstellen','en'=>'Revert to automatic value'],
'revert_auto_confirm' => ['de'=>'\"Verbunden mit\" auf den automatischen Wert zurücksetzen?','en'=>'Revert \"Linked to\" back to the automatic value?'],
'speed_none'          => ['de'=>'(keine)',        'en'=>'(none)'],
'status_free'         => ['de'=>'Frei',           'en'=>'Free'],
'status_linked'       => ['de'=>'Verbunden',      'en'=>'Linked'],
'status_reserved'     => ['de'=>'Reserviert',     'en'=>'Reserved'],
'hover_port'          => ['de'=>'Port',           'en'=>'Port'],
'hover_alias'         => ['de'=>'Alias',          'en'=>'Alias'],
'hover_peer'          => ['de'=>'Gegenstelle',    'en'=>'Peer'],
'hover_status'        => ['de'=>'Status',         'en'=>'Status'],
'hover_speed'         => ['de'=>'Geschwindigkeit','en'=>'Speed'],
'hover_vlans'         => ['de'=>'VLANs',          'en'=>'VLANs'],
'hover_note'          => ['de'=>'Notiz',          'en'=>'Note'],
'no_vlans'            => ['de'=>'Keine VLANs definiert','en'=>'No VLANs defined'],
'vlan_exists'         => ['de'=>'VLAN existiert bereits','en'=>'VLAN already exists'],
'delete_vlan_confirm' => ['de'=>'VLAN löschen?',  'en'=>'Delete VLAN?'],
'vlan_name_prompt'    => ['de'=>'VLAN Name:',     'en'=>'VLAN name:'],
...
'tab_backup'          => ['de'=>'Backup / Import','en'=>'Backup / Import'],
'backup_title'        => ['de'=>'Backup & Wiederherstellung','en'=>'Backup & Restore'],
'backup_hint'         => ['de'=>'Alle Profile als JSON-Backup exportieren oder aus einem Backup wiederherstellen.','en'=>'Export all profiles as a JSON backup file, or restore profiles from a backup.'],
'backup_btn'          => ['de'=>'Backup (alle Profile)','en'=>'Backup (all profiles)'],
'restore_btn'         => ['de'=>'Aus Backup wiederherstellen','en'=>'Restore from backup'],
'import_title'        => ['de'=>'Profil importieren','en'=>'Import Profile'],
'import_hint'         => ['de'=>'Ein einzelnes Profil aus einer zuvor exportierten JSON-Datei importieren.','en'=>'Import a single profile from a previously exported JSON file.'],
'import_btn'          => ['de'=>'Profildatei importieren','en'=>'Import profile file'],
